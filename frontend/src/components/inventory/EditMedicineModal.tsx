...
interface EditMedicineModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSuccess: (id: number, medicine: Partial<Medicine>) => void;
    medicine: Medicine | null;
}

export default function EditMedicineModal({ isOpen, onClose, onSuccess, medicine }: EditMedicineModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSuccess(medicine.id, updatedMedicine);
        handleClose();
    };
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Edit Medicine" size="lg">
